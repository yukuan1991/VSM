...
void fifo::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    const QLineF
            top_line (0.05 * item_width, item_height / 3, 0.95 * item_width, item_height / 3),
            bottom_line (0.05 * item_width, item_height / 3 * 2, 0.95 * item_width, item_height / 3 * 2);
    ...
    auto mid_point = QPointF (item_width / 2, item_height / 2);
    ...
    QPointF top_tip (0.9 * item_width, item_height / 2 + item_height * 2 / 80);
    QPointF bottom_tip (0.9 * item_width, item_height / 2 - item_height * 2 / 80);
    QPointF mid_tip (0.95 * item_width, item_height / 2);

    the_pen.setWidthF(0.01 * item_width);
    painter->setPen(the_pen);
