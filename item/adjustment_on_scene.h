...
{
public:
    static std::unique_ptr<adjustment_on_scene> make(json data, QPointF pos, abstract_item* parent);
    bool init();
protected:
    void paint (QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget = nullptr) override;
    adjustment_on_scene(json data, QPointF pos, abstract_item* parent = nullptr);
private:
